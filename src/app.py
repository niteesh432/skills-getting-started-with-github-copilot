...
activities = {
    ...
    "Swimming Club": {
        "description": "Improve swim techniques and train for swim meets",
    ...
    "Art Studio": {
        ...
        "max_participants": 15,
        "participants": ["ella@mergington.edu", "chloe@mergington.edu"]
    },
    "Music Ensemble": {
        "description": "Rehearse and perform musical pieces as a group",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["lucas@mergington.edu", "grace@mergington.edu"]
    },
    "Science Club": {
        "description": "Conduct experiments and dive into scientific inquiry",
